...
const QA = [
  ["Bagaimana cara mulai?", "Daftar akun, verifikasi email lewat kode OTP, isi saldo melalui QRIS, lalu pesan nomor dari dasbor."],
  ...
  ["Bagaimana isi saldo bekerja?", "Scan QRIS yang muncul di dasbor. Setelah pembayaran terdeteksi, saldo bertambah otomatis."],
