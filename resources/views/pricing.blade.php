...
<section class="page-grid min-h-[75vh] py-16">
    <div class="mx-auto max-w-7xl px-4 sm:px-6">
        <div class="max-w-3xl"><span class="badge bg-violet-100 text-violet-700 dark:bg-violet-500/15 dark:text-violet-300">Transparent Pricing</span><h1 class="text-balance mt-5 text-4xl font-black tracking-tight sm:text-5xl">Harga layanan OTP terbaru</h1><p class="mt-4 text-lg leading-8 text-slate-500 dark:text-slate-400">Bandingkan harga dan ketersediaan layanan dalam Rupiah sebelum melakukan pemesanan.</p></div>
