...
@php
    ...
    // Posisi HP dibuat konservatif agar wordmark tidak pernah terdorong keluar viewport.
    // Nilai lama yang ekstrem (mis. -40) otomatis dijepit ke -5 setelah deploy.
    $mobileShift = max(-5, min(30, (int) ($siteLogoMobileShift ?? 0)));
    ...
    $logoFrameStyle = $isSidebar
        ...
        : ($compact
            ? 'width:min(58vw,214px);height:60px;'
