...
@php($title = 'Pesanan')
@section('content')
<div class="flex flex-col justify-between gap-4 sm:flex-row sm:items-end"><div><h1 class="text-3xl font-black tracking-tight">Riwayat pesanan</h1></div><a href="{{ route('services.index') }}" class="btn-primary">Pesan baru</a></div>
