...
Route::match(['get', 'head'], '/meta/seo-image', SeoImageController::class)->name('meta.seo-image');
Route::match(['get', 'head'], '/og-image.jpg', [SeoImageController::class, 'social'])->name('meta.social-image');
