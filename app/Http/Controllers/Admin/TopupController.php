...
class TopupController extends Controller
{
    ...
    public function show(Topup $topup, PaymentGatewayManager $gateways): View { return view('admin.topups.show', ['topup' => $topup->load('user'), 'gatewayLabel' => $gateways->label($topup->gateway ?: 'pakasir')]); }
